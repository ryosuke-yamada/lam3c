#!/bin/bash
#PBS -N pi3-roomtours-batch-v8-hf
#PBS -q rt_HF
#PBS -P gag51402
...
LOG_BASE="pi3_roomtours_batch_v8_hf.${PBS_JOBID:-noid}.${PBS_ARRAY_INDEX:-noidx}"
...
echo "[INFO] Starting Pi3 batch processing for RoomTours batch v8"
EXTRA_ARGS=()
