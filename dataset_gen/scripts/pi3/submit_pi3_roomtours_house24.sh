...
CONFIG=roomtours
INPUT_BASE=${INPUT_BASE:-/groups/gag51402/datasets/RoomTours/processed_label_segments_house24_download}
OUTPUT_BASE=${OUTPUT_BASE:-/groups/gag51402/datasets/roomtours_pi3_house24}
INTERVAL=${INTERVAL:-1}
NUM_GPUS=${NUM_GPUS:-8}
...
LOG_BASE="pi3_roomtours_house24.${PBS_JOBID:-noid}.${PBS_ARRAY_INDEX:-noidx}"
...
echo "[INFO] Starting Pi3 batch processing for RoomTours house24 download"
...
# Example:
# qsub -J 1-8 -P gag51402 scripts/pi3/submit_pi3_roomtours_house24.sh
