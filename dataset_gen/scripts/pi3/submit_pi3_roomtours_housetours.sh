#!/bin/bash
#PBS -N pi3-roomtours-housetours
#PBS -q rt_HF
#PBS -P gag51492
#PBS -l select=1
...
CONFIG=roomtours
INPUT_BASE=${INPUT_BASE:-/groups/gag51402/datasets/RoomTours/processed_label_segments_HouseTours}
OUTPUT_BASE=${OUTPUT_BASE:-/groups/gag51402/datasets/roomtours_pi3_HouseTours}
INTERVAL=${INTERVAL:-1}
NUM_GPUS=${NUM_GPUS:-8}
...
LOG_BASE="pi3_roomtours_housetours.${PBS_JOBID:-noid}.${PBS_ARRAY_INDEX:-noidx}"
...
echo "[INFO] Starting Pi3 batch processing for RoomTours HouseTours"
...
# Example submission:
# qsub -J 1-8 -P gag51402 scripts/pi3/submit_pi3_roomtours_housetours.sh
