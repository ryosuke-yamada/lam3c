#!/bin/bash
#PBS -N pi3-roomtours-batch-v7-hf
#PBS -q rt_HF
#PBS -P gag51402
...
CONFIG=roomtours
INPUT_BASE=${INPUT_BASE:-/groups/gag51402/datasets/RoomTours/processed_label_segments_batch_v7}
OUTPUT_BASE=${OUTPUT_BASE:-/groups/gag51402/datasets/roomtours_pi3_batch_v7}
INTERVAL=${INTERVAL:-1}
NUM_GPUS=${NUM_GPUS:-8}
...
LOG_BASE="pi3_roomtours_batch_v7_hf.${PBS_JOBID:-noid}.${PBS_ARRAY_INDEX:-noidx}"
...
echo "[INFO] Starting Pi3 batch processing for RoomTours batch v7"
EXTRA_ARGS=()
