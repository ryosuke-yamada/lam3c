...
VIDEO_ROOT=${VIDEO_ROOT:-/groups/gag51402/datasets/RoomTours/raw_videos/batch_v7_download}
OUTPUT_ROOT=${OUTPUT_ROOT:-/groups/gag51402/datasets/RoomTours/processed_label_segments_batch_v7}
GPU_IDS=${GPU_IDS:-0}
CONCURRENCY=${CONCURRENCY:-1}

LOG_DIR="$PROJECT_DIR/logs"
mkdir -p "$LOG_DIR"
LOG_BASE="roomtour_label_batch_v7.${PBS_JOBID:-noid}"
