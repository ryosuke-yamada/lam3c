...
LOG_BASE="roomtour_label_v4.${PBS_JOBID:-noid}"
RUNNER_MODE="queue"
...
# qsub -P gag51402 -J 1-8 -v CONCURRENCY=8 scripts/segmentation/submit_roomtour_segmentation_v4_relaxed.sh
