#!/usr/bin/env python3
"""Public entrypoint for submitting the segmentation stage."""
...
INTERNAL_COMMAND = ROOT_DIR / "pipeline" / "submit_stage.sh"
STAGE = "segmentation"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Submit the segmentation stage")
    parser.add_argument(
        "dataset_config",
        nargs="?",
    ...
    cmd = [str(INTERNAL_COMMAND), STAGE, args.dataset_config]
