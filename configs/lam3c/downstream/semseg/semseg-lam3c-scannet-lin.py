...
num_worker = 48  # total dataloader workers across all GPUs
mix_prob = 0.8
clip_grad = 3.0
empty_cache = False
enable_amp = True

# pretrain checkpoint for downstream initialization
weight = "logs/lam3c_pretrain_base/model/model_last.pth"
